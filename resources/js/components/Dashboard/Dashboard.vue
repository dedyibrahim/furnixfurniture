...
export default {
  mounted() {
        if(!this.$cookies.get("token")){
               this.$root.$emit('PesanResponse',"Sesi Telah Habis Silahkan Login Kembali","primary");
               this.$router.push("/");
  ...
  data: () => ({
    ...
    links: [
      ...
      ["mdi-dots-horizontal", "Data Kategori", "/Dashboard/data-kategori"],
      ["mdi-newspaper-variant-multiple-outline", "Berita", "/Dashboard/data-berita"],
